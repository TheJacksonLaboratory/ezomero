...
def get_image(conn, image_id, no_pixels=False, start_coords=None,
    ...
    pyramid_level : int, optional
        If image has multiple pyramid levels and this argument is set, pixels are
        returned at the chosen resolution level, and all other arguments apply
        to that level as well. We follow the usual convention of `0` as full-
        resolution.
